		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Purchase Price From Supplier</span>
				</h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Purchase Price From Supplier</span>
				</div>
			</div>
		</div>
	</div>
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="card-title">List of Purchase Price From Supplier</h5>
			</div>
			<div class="card-body">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header bg-light">
            <h5 class="modal-title" id="exampleModalLabel">Form Purchase Price From Supplier</h5>
         ...
         <div class="modal-body">
            <form id="form_data">
               ...
               <div class="form-group">
                  <label>Purchase's Product :<span class="text-danger">*</span></label>
                  <select name="product_id" id="product_id"></select>
               </div>
               <div class="form-group">
                  <label>Purchase's Currency :<span class="text-danger">*</span></label>
               ...
               <div class="form-group">
                  <label>Purchase's Price :<span class="text-danger">*</span></label>
