         ...
         <div class="modal-body">
            <form id="form_data">
               ...
               <div class="form-group">
                  <label>Country's Code :<span class="text-danger">*</span></label>
                  <input type="text" name="code" id="code" class="form-control" placeholder="Enter code">
               </div>
               <div class="form-group">
                  <label>Country's Name :<span class="text-danger">*</span></label>
                  <input type="text" name="name" id="name" class="form-control" placeholder="Enter name">
               </div>
               <div class="form-group">
                  <label>Country's Phone Code :<span class="text-danger">*</span></label>
