	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="card-title">List of Brands</h5>
				<div class="header-elements">
         ...
         <div class="modal-body">
            <form id="form_data">
               ...
               <div class="form-group">
                  <label>Brand's Code :<span class="text-danger">*</span></label>
                  <input type="text" name="code" id="code" class="form-control" placeholder="Enter code">
               </div>
               <div class="form-group">
                  <label>Brand's Name :<span class="text-danger">*</span></label>
                  <input type="text" name="name" id="name" class="form-control" placeholder="Enter name">
               </div>
               <div class="form-group">
                  <label>Brand's Order (Website) :<span class="text-danger">*</span></label>
                  <input type="number" name="order" id="order" class="form-control" placeholder="0">
               </div>
               <div class="form-group">
                  <label>Brand's Image :</label>
