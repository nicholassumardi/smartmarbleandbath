				...
				<tr class="text-center">
				   ...
				   <td class="align-middle">
						<div class="form-check" style="padding-left: 0rem;">
							<label class="form-check-label">
							<input type="checkbox" class="form-check-input-styled-primary" value="1" name="credit_checkbox[]">
						</div>
				   </td>
				   <td class="align-middle">
					  <button type="button" id="delete_data_content_debit" class="btn bg-danger btn-sm"><i class="icon-trash"></i></button>   
					...
					$('#data_content_debit').append(`
						<tr class="text-center">
						   ...
						   <td class="align-middle">
								<div class="form-check" style="padding-left: 0rem;">
									<label class="form-check-label">
									<input type="checkbox" class="form-check-input-styled-primary" value="1" name="credit_checkbox[]" ` + (val.checked ? val.checked : ((counter == 1 ? `checked` : ``))) + `>
								</div>
						   </td>
						   <td class="align-middle">
							  <button type="button" id="delete_data_content_debit" class="btn bg-danger btn-sm"><i class="icon-trash"></i></button>   
   ...
   function update(id) {
	   var debit = 0, credit = 0;
		...
		$('input[name^="credit_checkbox"]').each(function(){
			if($(this).is(":checked")){
				fd.append("credit_checkbox[]", '1');
			}else{
				fd.append("credit_checkbox[]", '');
			}
		});
