...
<head>
	...
	<link rel="shortcut icon" href="{{ asset('website/icon.png?v=0') }}">
					...
					<div class="card shadow-lg bg-white rounded mb-0 w-100">
						<div class="card-body">
							...
							<!-- <div class="form-group mt-3">
								<a href="{{ url('admin/simple_login') }}" class="btn btn-success btn-block">Simple Login <i class="icon-users ml-2"></i></a>
							</div> -->
						</div>
					</div>
				</form>
