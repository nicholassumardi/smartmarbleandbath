...
<head>
	...
	<link href="{{ asset('template/back-office/custom_card.css?v=197') }}" rel="stylesheet">
	...
	<script src="{{ asset('template/back-office/global_assets/js/plugins/forms/styling/switchery.min.js?v=5') }}"></script>
	...
	<script src="{{ asset('template/back-office/custom.js?v=104') }}"></script>
	...
	<script src="{{ asset('template/back-office/global_assets/js/demo_pages/form_checkboxes_radios.js') }}"></script>
	<title>Smartmarble And Bath Admin - {{ $title }}</title>
</head>