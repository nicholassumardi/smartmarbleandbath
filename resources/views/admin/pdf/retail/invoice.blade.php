			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				...
				<tfoot>
					<tr>
						...
						<th colspan="2" style="text-align:right;">Rp {{ number_format($order->subtotal, 2, ',', '.') }}</th>
					</tr>
					<tr>
						<th colspan="4" style="text-align:right;">SHIPPING</th>
						<th colspan="2" style="text-align:right;">Rp {{ number_format($order->shipping, 2, ',', '.') }}</th>
					</tr>
					<tr>
						<th colspan="4" style="text-align:right;">DISCOUNT</th>
						<th colspan="2" style="text-align:right;">Rp {{ number_format($order->discount, 2, ',', '.') }}</th>
					</tr>
					<tr>
						<th colspan="4" style="text-align:right;">TOTAL</th>
						<th colspan="2" style="text-align:right;">Rp {{ number_format($order->grandtotal, 2, ',', '.') }}</th>
					</tr>
					<tr>
