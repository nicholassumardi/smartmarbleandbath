		...
		<div class="invoice-box">
					...
					<td colspan="2">
						<table width="100%">
							<tr style="line-height:0 !important;">
								...
								<td style="text-align:left; font-size:10px;">: {{ $project->date }}</td>
							</tr>
							<tr style="line-height:0 !important;">
							...
							<tr style="line-height:0 !important;">
								...
								<td style="text-align:left; font-size:10px;">: {{ $project->projectPurchase->projectSale ? $project->projectPurchase->projectSale->code : 'None' }}</td>
								<td></td>
								<td></td>
			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				...
				<tr style="background:#ebb220;text-align:center;">
					...
					<th colspan="2" align="right">Rp{{ number_format($project->getTotal(),2,',','.') }}</th>
				</tr>
			</table>
			<br>
			<table cellpadding="0" cellspacing="0">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="text-align:center;">
						...
						<div style="font-size:10px;font-weight:700;">{{ $project->approve->userRole->first()->role() }}</div>
					</td>
					@endif
				</tr>
			</table>
