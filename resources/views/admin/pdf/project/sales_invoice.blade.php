	...
	<body>
		<div class="invoice-box">
					...
					<td colspan="2">
						<table>
							...
							<tr>
								...
								<td style="text-align:right;padding-top:100px !important;">
			...
			@endphp
				...
				<tbody>
					@foreach($project->projectSale->projectSaleProduct as $key => $pp)
						...
						<tr>
							...
							<td style="vertical-align:center; font-size:24pt; word-wrap:break;">
								<center>
							...
							<td style="vertical-align:center;">
								<center>
									<img src="{{ $pp->product->type->image() }}" style="max-width:180px; border:1px solid #ddd; border-radius:4px; padding: 5px;" class="img-fluid img-thumbnail">
								</center>
							</td>
							<td style="vertical-align:center;">
								<center>
				...
				@endphp
			<br>
			<table cellpadding="0" cellspacing="0" class="payment-note">
				<tr>
					<td width="45%">
					...
					<td width="10%"></td>
					<td width="45%">
						<table cellpadding="2" cellspacing="0" border="1" class="payment-box">
							<tr>
								<td>
									<h6>SUBTOTAL</h6>
								</td>
							...
							<tr>
								...
								<td>
									<h6>IDR {{ $project->projectSale->project->ppn == '1' ? number_format(($total - $project->project->discount) + ($persenppn * ($total  - $project->project->discount)), 0, ',', '.') : number_format($total - $project->project->discount, 0, ',', '.') }}</h6>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<h6>IDR {{ number_format($totalpaid - $grandtotal + $totalreturn, 0, ',', '.') }}</h6>
								</td>
							</tr>
							@endif
							<tr>
			...
			<br>
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:12px;" class="list-payments">
				<thead>
		...
		<div class="separate-box">
			<table id="table-kwitansi" style="vertical-align: top;padding: 5px;font-size:13px;background-image: url({{ url('website/bg_kwitansi.png') }});" width="100%" height="auto">
				<tr>
					<td rowspan="6" width="20%" style="padding:0;"><img src="{{ url('website/logo_samping_1.png') }}" height="420px"></td>
				...
				<tr>
					...
					<td width="1%">:</td>
					<td>{{ App\Helper\SMB::say($totalPaidCurrentInv +  $totalreturn) }} Rupiahs</td>
				</tr>
				<tr>
					<td>For payment</td>
					<td width="1%">:</td>
				...
				<tr>
					<td>Total</td>
					<td width="1%">:</td>
					<td><div>Rp {{ number_format($totalPaidCurrentInv + $totalreturn,0,',','.') }}</div></td>
				</tr>
				<tr>
					<td></td>
					<td width="1%"></td>
