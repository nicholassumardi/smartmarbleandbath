	...
	<body>
				...
				<tr>
					<td colspan="2">
						<table width="100%">
							...
							<tr style="line-height:0 !important;">
								<td width="20%" style="font-size:12px;">DUE DATE</td>
							...
							<tr>
								<td>
									<div style="font-size:12px;">
										NOMINAL IN WORDS : {{ App\Helper\SMB::say($project->nominal) }} Rupiah
									</div>
								</td>
							</tr>
						</table>
					...
					<td width="45%">
						<table cellpadding="2" cellspacing="0" border="1">
							...
							<tr>
								...
								<td>
									<h6>IDR {{ number_format($project->project->discount, 0, ',', '.') }}</h6>
								</td>
							</tr>
							<tr style="background-color:#b0c3cf;">
								...
								<td>
									<h6>IDR {{ number_format(($total - $project->project->discount), 0, ',', '.') }}</h6>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<h6>IDR {{ $project->project->ppn == '1' ? number_format($persenppn * ($total - $project->project->discount), 0, ',', '.') : number_format(0, 0, ',', '.') }}</h6>
								</td>
							</tr>
							<tr style="background-color:#b0c3cf;">
								<td>
									<h6>GRANDTOTAL PRODUCT</h6>
								</td>
								<td>
									<h6>IDR {{ $project->project->ppn == '1' ? number_format(($total - $project->project->discount) + ($persenppn * ($total - $project->project->discount)), 0, ',', '.') : number_format($total - $project->project->discount, 0, ',', '.') }}</h6>
								</td>
							</tr>
							@php
							...
							<tr style="background-color:#ec8131;">
								<td>
									<h6>PAYMENT PRODUCT ({{ $grandtotalproduct ? round(($project->nominal/$grandtotalproduct) * 100) : 0 }}%)</h6>
								</td>
								<td>
									<h6>IDR {{ number_format($project->nominal,0,',','.') }}</h6>
								</td>
							</tr>
						</table>
						<p style="font-size:10pt;">Created at : {{ $project->created_at }}</p>
					</td>
				</tr>
				<tr>
					<td colspan="3">
			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:12px;">
				<thead>
					<tr style="background:#c92089;text-align:center;">
						<th style="color:white;" colspan="7"><center>List of Bills</center></th>
					</tr>
					<tr style="background:#c92089;text-align:center;">
						<th style="color:white;"><center>No.</center></th>
						<th style="color:white;"><center>Bill No.</center></th>
						<th style="color:white;"><center>Date Bill</center></th>
				...
				<tbody>
					@foreach($project->project->projectBill as $key => $pb)
						...
						<tr style="{{ $style }}">
							...
							<td><center>IDR {{ number_format($pb->nominal + $pb->nominal_service,0,',','.') }}</center></td>
							<td><center>IDR {{ number_format($pb->paid(),0,',','.') }}</center></td>
						</tr>
					@endforeach
				</tbody>
			</table>
		...
		<div class="separate-box">
			<table id="table-kwitansi" style="vertical-align: top;padding: 5px;font-size:13px;background-image: url({{ url('website/bg_kwitansi.png') }});" width="100%" height="auto">
				<tr>
					<td rowspan="6" width="20%" style="padding:0;"><img src="{{ $project->branch == 4 ? url('website/logo_samping_psi.png') : url('website/logo_samping_1.png') }}" height="420px"></td>
					<td width="25%">Receipt Number</td>
					<td width="1%">:</td>
					<td><?=str_replace('BI','RC-BI',$project->code)?>-PRODUCT</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="1%">:</td>
					<td>{{ App\Helper\SMB::say($project->nominal) }} Rupiah
					</td>
				</tr>
				<tr>
					<td>For payment</td>
					<td width="1%">:</td>
					<td>According to Project {{ $project->project->code }} Product</td>
				</tr>
				<tr>
					<td>Total</td>
					<td width="1%">:</td>
					<td><div style="border:1p solid black;padding:10px;">
						IDR {{ number_format($project->nominal, 0, ',', '.') }}</div></td>
				</tr>
		...
		<div class="invoice-box">
			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				<thead>
					<tr style="background:#ebb220;text-align:center;">
						<th style="color:white;" colspan="3"><center>SERVICE COST</center></th>
					</tr>
					<tr style="background:#ebb220;text-align:center;">
						<th style="color:white;"><center>NO</center></th>
						<th style="color:white;"><center>INFORMATION</center></th>
						<th style="color:white;"><center>TOTAL</center></th>
					</tr>
				</thead>
				<tbody>
					...
					<td width="45%">
						<table cellpadding="2" cellspacing="0" border="1" style="width:100% !important;">
							...
							<tr>
								<td>
									<div style="font-size:12px;">
										NOMINAL IN WORDS : {{ App\Helper\SMB::say($project->nominal_service) }} Rupiah
									</div>
								</td>
							</tr>
						</table>
					...
					<td width="45%">
						<table cellpadding="2" cellspacing="0" border="1">
							<tr style="background-color:#90acd5;">
								...
								<td>
									<h6>IDR {{ number_format($project->project->delivery_cost + $project->project->cutting_cost + $project->project->misc_cost, 0, ',', '.') }}</h6>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr style="background-color:#ec8131;">
								...
								<td>
									<h6>IDR {{ number_format($project->nominal_service,0,',','.') }}</h6>
								</td>
							</tr>
						</table>
						<p style="font-size:10pt;">Created at : {{ $project->created_at }}</p>
		...
		<div class="separate-box">
			<table id="table-kwitansi" style="vertical-align: top;padding: 5px;font-size:13px;background-image: url({{ url('website/bg_kwitansi.png') }});" width="100%" height="auto">
				<tr>
					<td rowspan="6" width="20%" style="padding:0;"><img src="{{ $project->branch == 4 ? url('website/logo_samping_psi.png') : url('website/logo_samping_1.png') }}" height="350px"></td>
					<td width="25%">Receipt Number</td>
					<td width="1%">:</td>
					<td><?=str_replace('BI','RC-BI',$project->code)?>-SERVICE</td>
				</tr>
				<tr>
					<td>Already received from</td>
					<td width="1%">:</td>
				...
				<tr>
					<td>Nominal in words</td>
					<td width="1%">:</td>
					<td>{{ App\Helper\SMB::say($project->nominal_service) }} Rupiah 
					</td>
				</tr>
				<tr>
					<td>For payment</td>
				...
				<tr>
					...
					<td width="1%">:</td>
					<td><div style="border:1p solid black;padding:10px;">
						IDR {{ number_format($project->nominal_service, 0, ',', '.') }}</div></td>
				</tr>
