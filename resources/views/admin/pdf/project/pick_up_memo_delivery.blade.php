					...
					<td colspan="2">
						<table>
							<tr>
								...
								{{ $project->projectSale->sales->branch == '1' ? 'Surabaya' : 'Jakarta' }}, {{ date('d M Y',strtotime($project->created_at)) }}
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>
						...
						<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
							...
							<tbody>
								@foreach($project->projectDeliveryProduct as $key => $ppku)
									@php
						...
						<br>
						Nama : {{ $project->pick_up_name }}
						<br>
						Nopol : {{ $project->pick_up_plat }}
						<br>
						Jenis Kendaraan : {{ $project->pick_up_vehicle }}
						<br>
