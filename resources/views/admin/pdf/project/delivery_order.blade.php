	...
	<body>
		<div class="invoice-box">
			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				...
				<tbody>
					@foreach($project->projectDeliveryProduct as $key => $ps)
						...
						<tr>
							...
							<td style="vertical-align:center;">
								<center>
									<img src="{{ $ps->product->type->image() }}" style="max-width:50px; border:1px solid #ddd; border-radius:4px; padding: 5px;" class="img-fluid img-thumbnail">
								</center>
							</td>
							<td style="vertical-align:center;">
								<center>
				...
				<thead>
					<tr>
						<th style="color:white;" colspan="9"> ... </th>
					</tr>
				</thead>
				@php
				}
			...
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%; font-size:10px;">
				...
				<thead>
					<tr style="background:#cf9604;text-align:center;">
						<th style="color:white;" colspan="9"><center>NON-TILES</center></th>
					</tr>
					<tr style="background:#cf9604;text-align:center;">
						<th style="color:white;"><center>NO</center></th>
						<th style="color:white;"><center>NAME</center></th>
				...
				<tr>
					...
					<td style="text-align:center;">
						...
						@else
							<br><br><br>
						@endif
						<div style="font-size:10px;font-weight:700;">( {{ isset($project->user->name) ? $project->user->name : '' }} )</div>
						<div style="font-size:10px;font-weight:700;">{{ isset($project->user->name) ? $project->user->userRole->first()->role() : '' }}</div>
					</td>
					@php
						}
					@endphp
