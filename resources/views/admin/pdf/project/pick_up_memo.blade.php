...
<html lang="en">
	<head>
		...
		<title>Pick-up Memo {{ $project->code }}</title>
		<style>
			body {
			...
			<table width="100%">
				<tr>
					<td>
						...
						Dengan Hormat,
						<br><br>
						Berikut saya buat memo pengambilan barang untuk mengambil barang ke {{ $project->supplier->name }}, dengan detail sebagai berikut:
						<br><br>
						...
						<br>
						<b>Alamat Pengambilan Surat Jalan :
						<br>
						{{ $project->supplier->address }}
						<br><br>
						Alamat Pengambilan Barang :
						<br>
						{{ $project->memo_address_item }}
						<br><br>
						Up : {{ $project->memo_up }}
						<br><br>
						</b>
						Pesanan an PT Perwira Tamaraya Abadi
						<br><br>
