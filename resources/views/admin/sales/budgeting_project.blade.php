			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
					  <label>Branch :<span class="text-danger" onchange="">*</span></label>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header bg-light">
            <h1 class="modal-title mt-4" id="exampleModalLabel" style="font-size:30px !important;">New Budget Project</h1>
            ...
            <form id="form_data">
               <div class="alert alert-danger" id="validation_alert" style="display:none;">
			    ...
			    <div class="row justify-content-center">
					...
					<div class="col-md-3">
						<button type="button" class="btn btn-success btn-block btn-mode" id="btn-import" style="font-size:30px;">IMPORT</button>
					</div>
					<div class="col-md-3">
						<button type="button" class="btn btn-outline-success btn-block btn-mode" id="btn-local" style="font-size:30px;">LOCAL</button>
					</div>
				</div>
				<div class="row justify-content-center mt-3">
					<div class="col-md-3">
						 <div class="form-group">
							...
							<select name="project_id" id="project_id" onchange="getProjectProduct(this.value)"></select>
						 </div>
					</div>
					<div class="col-md-3">
						 <div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group">
						  ...
						  <textarea name="remarks" id="remarks" class="form-control" rows="1" placeholder="Will be shown to director/owner..."></textarea>
						</div>
					</div>
				</div>
				<div class="row justify-content-center">
							...
							<table class="table table-bordered">
							 <thead class="table-secondary">
								<tr class="text-center">
								   ...
								   <th>Sqm</th>
								   <th width="15%">Buy Price (Origin Currency)</th>
								   <th width="15%">Sell Price / Unit (Before Tax)</th>
								   <th width="10%">Qty</th>
							 ...
							 <tfoot>
								<tr>
									...
									<th class="text-right" id="grandtotalsell" style="font-size:200%;">0</th>
					...
					<div class="col-md-3">
						<div class="form-group">
						  ...
						  <input type="text" name="percent_rental" id="percent_rental" class="form-control form-control-sm" placeholder="Enter..." value="2" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Fixed Cost (%) :</label>
						  <input type="text" name="percent_fixed" id="percent_fixed" class="form-control form-control-sm" placeholder="Enter..." value="2" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>RSV Profit (%) :</label>
						  <input type="text" name="percent_rsv" id="percent_rsv" class="form-control form-control-sm" placeholder="Enter..." value="5" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Interest of Payment Method (%) :</label>
						  <input type="text" name="percent_ipm" id="percent_ipm" class="form-control form-control-sm" placeholder="Enter..." value="2" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Interest of Buying Capital (%) :</label>
						  <input type="text" name="percent_ibc" id="percent_ibc" class="form-control form-control-sm" placeholder="Enter..." value="3" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Import Duty (%) :</label>
						  <input type="text" name="percent_import" id="percent_import" class="form-control form-control-sm" placeholder="Enter..." value="5" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Safe Guard (%) :</label>
						  <input type="text" name="percent_safe" id="percent_safe" class="form-control form-control-sm" placeholder="Enter..." value="19" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>PPN (%) :</label>
						  <input type="text" name="percent_ppn" id="percent_ppn" class="form-control form-control-sm" placeholder="Enter..." value="10" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>PPH (%) :</label>
						  <input type="text" name="percent_pph" id="percent_pph" class="form-control form-control-sm" placeholder="Enter..." value="7,5" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Fee MKJ (%) :</label>
						  <input type="text" name="percent_mkj" id="percent_mkj" class="form-control form-control-sm" placeholder="Enter..." value="5" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Fee PTA (%) :</label>
						  <input type="text" name="percent_pta" id="percent_pta" class="form-control form-control-sm" placeholder="Enter..." value="5" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Middle Man (%) :</label>
						  <input type="text" name="percent_mid" id="percent_mid" class="form-control form-control-sm" placeholder="Enter..." value="3" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
						  <label>Sales Commision (%) :</label>
						  <input type="text" name="percent_scom" id="percent_scom" class="form-control form-control-sm" placeholder="Enter..." value="1" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-12 text-center">
						<div class="form-group"><hr></div>
					...
					<div class="col-md-3">
						<div class="form-group">
						  <label>Exchange Rate :<span class="text-danger">*</span><i>(Fill 1 if IDR)</i></label>
						  <input type="text" name="exchange_rate" id="exchange_rate" class="form-control form-control-sm" placeholder="Enter nominal" value="15.000" onkeyup="formatRupiah(this);hitung();">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
         ...
         <div class="modal-footer bg-light">
			<div class="mr-auto" style="font-size:25px !important;">
				...
				&nbsp;&nbsp; % Real Profit : <span class="badge badge-secondary" id="percent_profit_real">0</span>
...
<script>
						...
						$.each(response.product, function(i, val) {
							$('#data_content_product').append(`
							  <tr class="text-center">
								...
								<input type="hidden" id="product_unit` + i + `" value="` + val.unitraw + `" name="product_unit[]">
								 <td class="align-middle">` + val.product + `</td>
								 <td class="align-middle" id="carton_sqm` + i + `">
									` + val.carton_sqm + `
								 </td>
								 <td class="align-middle">
									<div class="form-group form-group-feedback form-group-feedback-right">
										<div class="position-relative">
											<input type="text" class="form-control form-control-sm" id="purchase_price` + i + `" value="` + val.purchase_price + `" onkeyup="formatRupiah(this);count(` + i + `);" name="product_price[]">
								 ...
								 <td class="align-middle">
									<div class="form-group form-group-feedback form-group-feedback-right">
										<div class="position-relative">
											<input type="text" class="form-control form-control-sm" id="sell_price` + i + `" value="` + val.sell_price + `" onkeyup="formatRupiah(this);countSell(` + i + `);" name="product_price_sell[]">
											<div class="form-control-feedback font-weight-bold">-</div>
										</div>
									</div>
								 </td>
								 <td class="align-middle">
									<div class="form-group form-group-feedback form-group-feedback-right">
										<div class="position-relative">
											<input type="number" class="form-control form-control-sm" id="product_qty` + i + `" value="` + val.qty + `" onkeyup="count(` + i + `);countSell(` + i + `);" name="product_qty[]">
											<div class="form-control-feedback font-weight-bold">` + val.unit + `</div>
										</div>
									</div>
								 </td>   
								 <td class="text-right">
									<span id="total` + i + `" class="total">0</span>
								 </td>
								 <td class="text-right">
									<span id="totalsell` + i + `" class="totalsell">0</span>
								 </td>
								 <td class="align-middle">
	...
	function countSell(id){
		...
		var price = $('#sell_price' + id).val().replaceAll(".", "").replaceAll(",", "."),
			product_qty = $('#product_qty' + id).val(),
			m2 = $('#carton_sqm' + id).text().match(/[\d\.]+/)[0],
			unit = $('#product_unit' + id).val(),
			qty = product_qty;

		if (unit == '2' || unit == '3') {
			qty = m2 * Math.ceil((product_qty / m2));
		}
						...
						$('#data_content_product').append(`
						  <tr class="text-center">
							...
							<input type="hidden" id="product_unit` + i + `" value="` + val.unitraw + `" name="product_unit[]">
							 ...
							 <td class="text-right">
								<span id="total` + i + `" class="total">` + val.total + `</span>
							 </td>
							 <td class="text-right">
								<span id="totalsell` + i + `" class="totalsell">` + val.total_sell + `</span>
							 </td>
							 <td class="align-middle">
								<button type="button" id="delete_data_product" class="btn bg-danger btn-sm"><i class="icon-trash"></i></button>   
							 </td>
