		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Edit Kelengkapan Data</span>
				</h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Tambah/Edit</span>
				</div>
			</div>
		</div>
	</div>
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="card-title">Edit Kelengkapan Data</h5>
			</div>
			<div class="card-body">
				<form id="form_data">
							...
							<div class="form-group">
								...
								<select name="al_customer_id" id="al_customer_id" class="select2">
									 ...
									 @foreach($customer as $p)
										<option value="{{ $p->id }}" {{ $p->id == $document->al_customer_id ? 'selected' : '' }}>{{ $p->name.' - '.$p->initial }}</option> 
									 @endforeach
								</select>
							</div>
						</div>
	...
	<script>
		...
		class MyUploadAdapter {
		   constructor(loader) {
			  ...
			  this.url = '{{ url("admin/al/kelengkapan_data/ckeditor") }}';
		   }
		   upload() {
