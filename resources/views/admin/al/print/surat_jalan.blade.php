...
<html lang="en">
	<head>
		...
		<title>Surat Jalan Barang {{ $data->code }}</title>
		...
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td width="50%">
						Kepada
						<br>
						Yth. Bpk/Ibu <u>{{ $data->to_whom }}</u>
						<br>
						<u>{{ $data->alProject->alCustomer->name }}</u>
						<br>
						Di Tempat
					</td>
					<td width="50%">
						...
						<table border="1" cellpadding="3" cellspacing="0" style="width:100%; font-size:13px;">
							<thead>
								<tr style="background:#cf9604;text-align:center;">
									...
									<th style="color:white;"><center>Jml</center></th>
									<th style="color:white;"><center>Satuan</center></th>
									<th style="color:white;"><center>Keterangan</center></th>
								</tr>
							</thead>
							<tbody>
								@foreach($data->alDeliveryProduct()->get()->sortBy('alProduct.name') as $key => $ps)
									<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td style="text-align: center;" width="33%">
						{{ ucwords(strtolower($data->city->name)) }}, {{ App\Helper\SMB::tgl_indo($data->date_sent) }}
						<br>
