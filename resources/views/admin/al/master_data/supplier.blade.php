		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">AL Supplier</span>
				</h4>
			</div>
  ...
  function success() {
   ...
   function loadDataTable() {
      return $('#datatable_serverside').DataTable({
         ...
         order: [[0, 'asc']],
         ajax: {
            url: '{{ url("admin/al/master_data/supplier/datatable") }}',
            type: 'GET',
            data: {
	...
	function create() {
      $.ajax({
         url: '{{ url("admin/al/master_data/supplier/create") }}',
         type: 'POST',
         dataType: 'JSON',
   ...
   function show(id) {
      toShow();
      $.ajax({
         url: '{{ url("admin/al/master_data/supplier/show") }}',
         type: 'GET',
         dataType: 'JSON',
         data: {
            id: id
   ...
   function update(id) {
      $.ajax({
         url: '{{ url("admin/al/master_data/supplier/update") }}' + '/' + id,
         type: 'POST',
         dataType: 'JSON',
         data: $('#form_data').serialize(),
         headers: {
      ...
      var notyConfirm = new Noty({
         ...
         buttons: [
            ...
            Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
               $.ajax({
                  url: '{{ url("admin/al/master_data/supplier/destroy") }}',
                  type: 'POST',
                  dataType: 'JSON',
                  data: {
                     id: id
