		...
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4>
					...
					<span class="font-weight-semibold">Education Data {{ $name }}</span>
				</h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Education - {{ $name }}</span>
	...
	<div class="content">
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="card-title">List of All Education</h5>
				<div class="header-elements">
					...
					<div class="col-md-8">
						<form id="form_data">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Grade :<sup class="text-danger">*</sup></label>
								<div class="col-lg-9">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Institution :<sup class="text-danger">*</sup></label>
								<div class="col-lg-9">
									<input type="text" class="form-control" name="institution" id="institution" placeholder="SMAN...">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Majors :<sup class="text-danger">*</sup></label>
								<div class="col-lg-9">
									<input type="text" class="form-control" name="majors" id="majors" placeholder="Teknik Mesin...">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-3 col-form-label">Score :<sup class="text-danger">*</sup></label>
								<div class="col-lg-9">
									<input type="number" class="form-control" name="score" id="score" value="0">
								</div>
							</div>
							<div class="form-group row">
							  <label class="col-lg-3 col-form-label">Year Start :<span class="text-danger">*</span></label>
							  <div class="col-lg-9">
									<input type="number" class="form-control" name="year_start" id="year_start" value="{{ date('Y') }}">
							  </div>
							</div>
							<div class="form-group row">
							  <label class="col-lg-3 col-form-label">Year End :<span class="text-danger">*</span></label>
							  <div class="col-lg-9">
									<input type="number" class="form-control" name="year_end" id="year_end" value="{{ date('Y') }}">
							  </div>
							</div>
						</form>
					</div>
...
<script>
	  ...
	  var notyConfirm = new Noty({
		 ...
		 buttons: [
			...
			Noty.button('<i class="icon-trash"></i>', 'btn bg-success ml-1', function() {
			   $.ajax({
				  url: '{{ url("admin/hrd/employee/education/destroy") }}',
				  type: 'POST',
				  dataType: 'JSON',
				  data: {
					 id: id
	...
	function loadDataTable() {
      return $('#datatable_serverside').DataTable({
         ...
         order: [[1, 'asc']],
         ajax: {
            url: '{{ url("admin/hrd/employee/education/".$id."/datatable") }}',
            type: 'GET',
            beforeSend: function() {
	...
	function create() {
	  $.ajax({
		 url: '{{ url("admin/hrd/employee/education/create") }}',
		 type: 'POST',
		 dataType: 'JSON',
	...
	function show(id) {
	  $.ajax({
		 url: '{{ url("admin/hrd/employee/education/show") }}',
		 type: 'POST',
		 dataType: 'JSON',
		 data: {
			id: id
		 ...
		 success: function(response) {
			...
			$('#majors').val(response.majors);
			$('#score').val(response.score);
			$('#year_start').val(response.start_year);
			$('#year_end').val(response.end_year);
