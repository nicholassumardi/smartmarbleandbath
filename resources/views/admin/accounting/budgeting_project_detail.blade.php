        ...
        <div class="page-header-content header-elements-md-inline">
			...
			<div class="header-elements">
				<div class="d-flex justify-content-center">
					<a href="{{ url('admin/accounting/budgeting_project') }}" class="btn bg-secondary btn-labeled btn-labeled-left">
	...
	<script>
		...
		function saveEstimation(){
			...
			if(kosong){
				...
				$.ajax({
					 url: '{{ url("admin/accounting/budgeting_project/updateEstimation") }}',
					 type: 'POST',
					 dataType: 'JSON',
