          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="{{ url('/') }}" class="f-fallback email-masthead_name">Smartmarble And Bath</a>
              </td>
            </tr>
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>
                          If you have any questions about <a href="{{ url('/') }}">info@smartmarbleandbath.com</a>, simply reply to this email or reach out to our 
                          <a href="mailto:info@smartmarbleandbath.com">support team</a> 
                          for help.
                        </p>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; {{ date('Y') }} Smartmarble And Bath. All rights reserved.</p>
