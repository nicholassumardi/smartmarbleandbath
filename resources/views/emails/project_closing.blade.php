                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi {{ $name }},</h1>
                        <p>
							Here, we want to inform you that Project {{ $project->code }} with details as follow;
						</p>
						<ol>
							<li>Customer : {{ $project->customer->name }}</li>
							<li>Project Name : {{ $project->name }}</li>
						</ol>
						<p>
							has been CLOSED successfully by {{ $closed_by }}.
						</p>
                        <p>
