      ...
      <ul class="testimonials-grid grid-1 grid-md-1 grid-lg-1">
         <li class="grid-item">
            <div class="testimonial">
               ...
               <div class="testi-content">
                  <div class="font-weight-bold"><a href="{{ url('account/login') }}" class="text-primary">Login</a> into your Smartmarble And Bath account. Haven't had an account? Please register in Register <a href="{{ url('account/register') }}" class="text-primary">Here</a> and complete your personal data.</div>
                  <p style="font-size:14px;" class="text-muted"><a href="{{ url('account/login') }}" class="text-primary">Login</a> ke dalam akun Smartmarble And Bath anda. Apabila belum memiliki akun, silahkan register terlebih dahulu di register <a href="{{ url('account/register') }}" class="text-primary">here</a> dan melengkapi data diri anda.</p>
               </div>
            </div>
         </li>
         <li class="grid-item">
         ...
         <li class="grid-item">
            <div class="testimonial">
               ...
               <div class="testi-content">
                  <div class="font-weight-bold">After verification, <a href="{{ url('account/login') }}" class="text-primary">Login</a> into your new Smartmarble And Bath Account with registed-email and password.</div>
                  <p style="font-size:14px;" class="text-muted">Setelah verifikasi, silahkan <a href="{{ url('account/login') }}" class="text-primary">Login</a> ke dalam akun Smartmarble And Bath anda dengan email dan kata sandi yang terdaftar.</p>
               </div>
            </div>
         </li>
         <li class="grid-item">
