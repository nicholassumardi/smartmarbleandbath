						...
						<div class="col-lg-8 col-md-12">
							<div class="widget clearfix">
								<p class="mb-0 font-size-14">
									Smartmarble And Bath is a subsidiary company of Karya Modern Group. Karya Modern Group has been in tile and sanitary business for more than 42 Years. Karya Modern Group started as a building material store back in 1976. Our main office is located in Surabaya, East Java
							...
							<div class="widget subscribe-widget">
								<div class="card bg-light">
									<div class="card-body">
										...
										<h5 class="card-title mb-4 text-center font-weight-semibold text-uppercase">Surabaya</h5>
			...
			<div id="copyrights">
				<div class="container">
					<div class="row justify-content-between col-mb-30">
						<div class="col-12 text-center">
							&copy; Smartmarble And Bath {{ date('Y') }} All Rights Reserved. Powered by <a href="https://hirosolution.com" target="_blank" class="text-dark">Hirosolution.com</a>
						</div>
						<div class="col-12">
							<center>
